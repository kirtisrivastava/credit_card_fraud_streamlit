# -*- coding: utf-8 -*-
"""Streamlitapp_kirti.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1FuPbiOuK2J7eUi-67Kp9zybxE4rCxWvB
"""
...
st.set_page_config(
    page_title='Credit card fraud detection analysis',
    layout='wide'
)
...
st.title('Credit Card Fraud Detection Data')

# Add developer header
st.header('Developed by Kirti Srivastava - email (2025aa05532@wilp.bits-pilani.ac.in)')
...
sample_data_url = "https://www.kaggle.com/datasets/mlg-ulb/creditcardfraud?resource=download"

try:
    response = requests.get(sample_data_url)
    if response.status_code == 200:
        st.download_button(
            label="Download Sample 'creditcard.csv'",
